...
namespace Mediapipe.Unity
{
  public class Bootstrap : MonoBehaviour
  {
    ...
    private IEnumerator Init()
    {
      ...
      // Quest passthrough apps provide ImageSource later (e.g. PassthroughImageSource).
      if (_defaultImageSource != ImageSourceType.Unknown)
      {
        ImageSourceProvider.ImageSource = GetImageSource(_defaultImageSource);
      }
      else
      {
        Logger.LogInfo(_TAG, "Skipping default ImageSource; expect external provider.");
      }
